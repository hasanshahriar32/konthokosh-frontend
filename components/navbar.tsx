    ...
    <nav className="absolute top-0 left-0 right-0 z-30 bg-black/20 backdrop-blur-sm">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="text-white font-kalpurush text-xl font-semibold">কণ্ঠ কোষ</div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <SignedOut>
              <SignInButton mode="modal">
                <Button variant="ghost" className="text-white hover:bg-white/20 font-bengali">
                  প্রবেশ
                </Button>
              </SignInButton>
              <SignUpButton mode="modal">
                <Button className="bg-red-600 hover:bg-red-700 text-white font-bengali">নিবন্ধন</Button>
              </SignUpButton>
            </SignedOut>
            <SignedIn>
              <UserButton
          ...
          <div className="md:hidden mt-4 pb-4 border-t border-white/20">
            <div className="flex flex-col space-y-4 pt-4">
              ...
              <div className="border-t border-white/20 pt-4 space-y-2">
                <SignedOut>
                  <SignInButton mode="modal">
                    <Button variant="ghost" className="w-full text-white hover:bg-white/20 font-bengali">
                      প্রবেশ
                    </Button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-bengali">নিবন্ধন</Button>
                  </SignUpButton>
                </SignedOut>
                <SignedIn>
