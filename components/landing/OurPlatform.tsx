    ...
    <section className="py-24 overflow-hidden bg-background">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="heading-primary mb-6">{ourPlatform.title}</h2>
          <p className="text-subtitle">{ourPlatform.description}</p>
        </div>
        <div className="max-w-4xl mx-auto animate-fade-in-up">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-shadow duration-500">
            ...
            >
              <source src={ourPlatform.videoSrc} type="video/mp4" />
